...
const ChooseVehicle = ({image, price, capacity, name, setconfirmRide}) => {
    return (
        <div className='flex items-center justify-between gap-1 p-2 shadow-lg mx-3 bg-white border-2 active:border-black rounded-lg my-3' onClick={() => setconfirmRide(true)}>
